...
void printSquirrelLevelOrderUtils(stack<bstptr> &s, bool flag)
{
    if(s.empty())
        return;
    stack<bstptr> s2;
    ...
    printSquirrelLevelOrderUtils(s2, 1-flag);
    return;
}

void printSquirrelLevelOrder(bstptr T, bool flag)
{
    stack<bstptr> s;
    s.push(T);
    printSquirrelLevelOrderUtils(s, flag);
    return;
}
int main()
{
    ...
    printSquirrelLevelOrder(T, true);  cout<<endl;
    printSquirrelLevelOrder(T, false);   cout<<endl;
